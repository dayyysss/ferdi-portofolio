      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full">
          <div className="text-center md:text-left">
            <motion.h3
              className={`${styles.heroHeadText} text-white text-lg md:text-xl mb-1`}
              initial={{ x: -100, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
              transition={{
                delay: 0.2,
            ...
            <motion.h1
              className={`${styles.heroHeadText2} text-white text-xl md:text-2xl mt-[-30px]`}
              initial={{ x: -100, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
              transition={{
                delay: 0.3,
            ...
            <motion.h1
              className={`${styles.heroHeadText2} text-white text-xl md:text-2xl mt-[-20px]`}
              initial={{ x: -100, opacity: 0 }}
              whileInView={{ x: 0, opacity: 1 }}
              transition={{
                delay: 0.3,
          ...
          <motion.img
            src={me}
            alt="Profile"
            className="w-[200px] h-[200px] md:w-[400px] md:h-[400px] object-cover rounded-full mt-5 md:mt-0 ml-0 md:ml-5 lg:px-12 grayscale hover:grayscale-0 transition-all ease duration-300"
            initial={{ x: 100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{
              delay: 0.7,
